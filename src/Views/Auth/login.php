    ...
    <div class="loginWindow">
        <div class="container">
            <div class="row">
                <div class="col-6 text-light container-fluid">
                    ...
                    <div class="d-flex flex-row align-items-center">
                        <div>
                            ...
                            <img src="public/images/logo.svg" alt="Pryta Logo">
                        </div>
                        <div>
                    ...
                    <form action="?action=authenticate" method="post">
                        ...
                        <div class="mb-3">
                            <label for="username" class="form-label text-light">Please enter your username:</label> <br>
                            <input
                                type="text"
                                class="form-control"
                                name="username"
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label text-light">Please enter your password:</label> <br>
                            <input
                                type="password"
                                class="form-control"
                                name="password"
                ...
                <div class="col-6">
                    <img src="public/images/ejemplo.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
