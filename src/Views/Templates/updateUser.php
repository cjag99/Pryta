    ...
    <div class="card-body">
        <form id="registerForm" action="index.php?controller=dashboard&action=create" method="post" novalidate onsubmit="return validateRegister(event)">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="reg_username" name="username" value="<?= $user->getUsername() ?>" required>
            </div>
            <div class="row g-2">
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        <label for="reg_name" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="reg_name" name="name" value="<?= $user->getName() ?>" required>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        <label for="reg_surname" class="form-label">Apellidos</label>
                        <input type="text" class="form-control" id="reg_surname" name="surname" value="<?= $user->getSurname() ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="reg_email" name="email" value="<?= $user->getEmail() ?>" required>
